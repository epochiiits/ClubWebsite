    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground">Capturing moments from our tech community events</p>
        </div>
        ...
        {galleries.length === 0 ? (
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground">Check back later for photos from our events!</p>
            </CardContent>
          </Card>
        ) : (
              ...
              <Link key={gallery._id} href={`/gallery/${gallery._id}`}>
                <Card className="group overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <div className="aspect-video bg-muted overflow-hidden">
                    {gallery.images && gallery.images.length > 0 ? (
                      <div className="relative">
                        <Image
                          src={gallery.images[0].url || "/placeholder.svg?height=200&width=300&text=Event+Photo"}
                  ...
                  <CardContent className="p-4">
                    <h3 className="font-semibold text-lg mb-2 line-clamp-1">{gallery.eventName}</h3>
                    {gallery.description && (
