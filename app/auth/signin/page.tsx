...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md rounded-xl shadow-md border border-border bg-card">
        <CardHeader className="text-center space-y-2">
          <CardTitle className="text-3xl font-bold">Welcome to Epoch</CardTitle>
        ...
        <CardContent className="space-y-6 px-6 pb-8">
          ...
          {providers?.google && (
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground">Fast · Secure · Seamless</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="space-y-4 text-center text-sm text-muted-foreground">
            <p>
              Sign in with your Google account to access personalized dashboards,
              project insights, and collaboration tools — all in one place.
            </p>
            <p>
              Need help?{" "}
