...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-muted px-4 sm:px-6 lg:px-8 py-12">
  <Card className="w-full max-w-md bg-card border border-border rounded-2xl shadow-xl">
    <CardHeader className="text-center space-y-2 pb-0">
      <CardTitle className="text-3xl font-extrabold text-foreground">Welcome to Epoch</CardTitle>
    ...
    <CardContent className="space-y-6 pt-2 pb-8 px-6">
      ...
      {providers?.google && (
        <div className="space-y-4">
          <Button
            onClick={handleGoogleSignIn}
            disabled={loading}
            className="w-full py-5 text-base font-medium shadow-sm hover:shadow-md transition-shadow"
            size="lg"
            variant="outline"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-wide">
              <span className="bg-card px-3 text-muted-foreground">Fast · Secure · Seamless</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="space-y-3 text-center text-sm text-muted-foreground">
        ...
        <p>
          Need help?{" "}
          <a href="/support" className="text-primary underline hover:text-primary/80 transition">
            Contact support
          </a>
        </p>
